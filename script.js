...
// Seleção de Containers (Listas dinâmicas)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // A. Carrega as estruturas dinâmicas salvas
    ...
    // B. Carrega os textos salvos individualmente
    ...
    // C. Aplica o efeito visual 3D nos cards
    aplicarEfeito3D();

    // D. Efeito Máquina de Escrever (Sincronizado)
    ...
    // E. Animação de Surgimento Suave (Fade-in com Scroll)
...
// ==========================================
// 4. FUNÇÕES DE SENHA SEGURA E EXCLUSÃO (LIXEIRA)
// ==========================================
function pedirSenhaSegura(callback) {
    let modalEl = document.getElementById('modalSenhaAdmin');
    
    // Injeta o HTML do modal de senha se não existir
    if (!modalEl) {
        const html = `
    ...
    // Foca no input para digitação imediata
    ...
    // Remove eventos duplicados recriando o botão
...
// ==========================================
// 5. ATIVAÇÃO DO MODO ADMIN (BOTÃO PRINCIPAL)
// ==========================================
if (btnAdmin) {
    btnAdmin.addEventListener('click', () => {
        if (!modoEdicaoAtivo) {
            ...
            alert("Portfólio atualizado com sucesso no navegador!");
        }
    });
}
